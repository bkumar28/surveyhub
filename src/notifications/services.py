...
class NotificationService:
    ...
    def send_survey_invitation_email(self, invitation):
        """Send styled survey invitation email"""
        context = {
            'survey': invitation.survey,
            'invitation': invitation,
            'survey_url': f"{settings.FRONTEND_URL}/survey/{invitation.survey.id}?token={invitation.token}"
        }
        ...
        text_content = render_to_string('emails/survey_invitation.txt', context)
