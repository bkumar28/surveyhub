rom django.db.models import Count, Avg, Q, F
from django.utils import timezone
from datetime import timedelta, datetime
import json
from collections import defaultdict, Counter
from src.surveys.models import Survey, Question, Answer, SurveyResponse
...
class AnalyticsService:
    ...
    def get_response_analytics(self):
        ...
        user_agents = responses.values('user_agent').annotate(
            count=Count('id')
        ).order_by('-count')[:10]
    ...
    def get_question_analytics(self):
        ...
        for question in self.survey.questions.all():
            ...
            analytics = {
                ...
                'answer_rate': (total_answers / total_responses * 100) if total_responses > 0 else 0,
                'skip_rate': ((total_responses - total_answers) / total_responses * 100) if total_responses > 0 else 0,
            }
    ...
    def _analyze_text_question(self, question, answers):
        ...
        # Average length
        avg_length = text_answers.aggregate(
            avg_len=Avg(F('text_answer__length'))
        )['avg_len'] or 0
    ...
    def _analyze_rating_question(self, question, answers):
        ...
        # Rating distribution
        rating_counts = number_answers.values('number_answer').annotate(
            count=Count('id')
        ).order_by('number_answer')
        
        avg_rating = number_answers.aggregate(
    ...
    def _get_abandonment_points(self):
        ...
        for i, question in enumerate(questions):
            ...
            abandonment_rate = ((total_responses - answered_count) / total_responses * 100) if total_responses > 0 else 0
