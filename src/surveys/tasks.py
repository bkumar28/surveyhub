...
from .models import SurveyInvitation, Survey
...
def update_survey_analytics():
    ...
    from src.analytics.models import SurveyAnalytics
    ...
    for survey in Survey.objects.filter(status='A'):
        ...
        if total_responses > 0:
            analytics.abandonment_rate = ((total_responses - completed_responses) / total_responses) * 100
