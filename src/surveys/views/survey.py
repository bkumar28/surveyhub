...
from core.api_message import SURVEY_UPDATE_SUCCESS, SURVEY_DELETE_SUCCESS, SURVEY_CREATE_SUCCESS, \
...
from surveys.serializers.survey import SurveyCreateSerializer, SurveyUpdateSerializer, SurveyViewSerializer, \
